...
@interface TokenizerTest4Tests : XCTestCase
...
- (void)test00
{
    ...
    for (NSString *state in @[@""]) {
        ...
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"< in attribute name");
    }
}
...
- (void)test01
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"< in attribute value");
    }
}
...
- (void)test02
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"= in unquoted attribute value");
    }
}
...
- (void)test03
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"= attribute");
    }
}
...
- (void)test07
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"\" after ampersand in double-quoted attribute value");
    }
}
...
- (void)test09
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<z z='&'>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"' after ampersand in single-quoted attribute value");
    }
}
...
- (void)test11
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Text after bogus character reference");
    }
}
...
- (void)test12
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Text after hex character reference");
    }
}
...
- (void)test13
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Attribute name starting with \"");
    }
}
...
- (void)test15
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Attribute name containing \"");
    }
}
...
- (void)test17
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Unquoted attribute value containing '");
    }
}
...
- (void)test19
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<foo a=\"b\"c>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Double-quoted attribute value not followed by whitespace");
    }
}
...
- (void)test20
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<foo a='b'c>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Single-quoted attribute value not followed by whitespace");
    }
}
...
- (void)test21
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Quoted attribute followed by permitted /");
    }
}
...
- (void)test22
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Quoted attribute followed by non-permitted /");
    }
}
...
- (void)test23
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"CR EOF after doctype name");
    }
}
...
- (void)test24
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"CR EOF in tag name");
    }
}
...
- (void)test25
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<z/"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Slash EOF in tag name");
    }
}
...
- (void)test26
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Zero hex numeric entity");
    }
}
...
- (void)test27
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Zero decimal numeric entity");
    }
}
...
- (void)test28
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Zero-prefixed hex numeric entity");
    }
}
...
- (void)test29
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Zero-prefixed decimal numeric entity");
    }
}
...
- (void)test30
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Empty hex numeric entities");
    }
}
...
- (void)test31
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"&# &#; "];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Empty decimal numeric entities");
    }
}
...
- (void)test32
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Non-BMP numeric entity");
    }
}
...
- (void)test33
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Maximum non-BMP numeric entity");
    }
}
...
- (void)test34
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Above maximum numeric entity");
    }
}
...
- (void)test35
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"32-bit hex numeric entity");
    }
}
...
- (void)test36
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"33-bit hex numeric entity");
    }
}
...
- (void)test37
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"33-bit decimal numeric entity");
    }
}
...
- (void)test38
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"65-bit hex numeric entity");
    }
}
...
- (void)test39
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"65-bit decimal numeric entity");
    }
}
...
- (void)test40
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"&#xD7FF;&#xD800;&#xD801;&#xDFFE;&#xDFFF;&#xE000;"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Surrogate code point edge cases");
    }
}
...
- (void)test41
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Uppercase start tag name");
    }
}
...
- (void)test42
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"</X>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Uppercase end tag name");
    }
}
...
- (void)test43
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<x X>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Uppercase attribute name");
    }
}
...
- (void)test44
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Tag/attribute name case edge values");
    }
}
...
- (void)test45
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Duplicate different-case attributes");
    }
}
...
- (void)test46
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"</x X>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Uppercase close tag attributes");
    }
}
...
- (void)test47
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Duplicate close tag attributes");
    }
}
...
- (void)test48
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Permitted slash");
    }
}
...
- (void)test49
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Non-permitted slash");
    }
}
...
- (void)test50
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"</br/>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Permitted slash but in close tag");
    }
}
...
- (void)test51
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype public case-sensitivity (1)");
    }
}
...
- (void)test52
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!dOcTyPe hTmL pUbLiC \"aBc\" \"xYz\">"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype public case-sensitivity (2)");
    }
}
...
- (void)test53
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype system case-sensitivity (1)");
    }
}
...
- (void)test54
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!dOcTyPe hTmL sYsTeM \"xYz\">"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype system case-sensitivity (2)");
    }
}
...
- (void)test55
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"U+0000 in lookahead region after non-matching character");
    }
}
...
- (void)test56
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:[NSString stringWithFormat:@"<!doc%C", (unichar)0x0000]];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"U+0000 in lookahead region");
    }
}
...
- (void)test57
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"U+0080 in lookahead region");
    }
}
...
- (void)test58
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!doc﷑"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"U+FDD1 in lookahead region");
    }
}
...
- (void)test59
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!doc🿿"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"U+1FFFF in lookahead region");
    }
}
...
- (void)test60
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"CR followed by non-LF");
    }
}
...
- (void)test61
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"\r"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"CR at EOF");
    }
}
...
- (void)test62
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"\n"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"LF at EOF");
    }
}
...
- (void)test63
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"\r\n"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"CR LF");
    }
}
...
- (void)test64
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"CR CR");
    }
}
...
- (void)test65
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"\n\n"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"LF LF");
    }
}
...
- (void)test66
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"\n\r"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"LF CR");
    }
}
...
- (void)test67
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"text CR CR CR text");
    }
}
...
- (void)test68
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype publik");
    }
}
...
- (void)test69
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype publi");
    }
}
...
- (void)test70
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype sistem");
    }
}
...
- (void)test71
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype sys");
    }
}
...
- (void)test72
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype html x>text");
    }
}
...
- (void)test73
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Grave accent in unquoted attribute");
    }
}
...
- (void)test74
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in tag name state ");
    }
}
...
- (void)test76
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<a "];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in before attribute name state");
    }
}
...
- (void)test77
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in attribute name state");
    }
}
...
- (void)test78
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<a a "];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in after attribute name state");
    }
}
...
- (void)test79
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<a a ="];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in before attribute value state");
    }
}
...
- (void)test80
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in attribute value (double quoted) state");
    }
}
...
- (void)test81
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<a a ='a"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in attribute value (single quoted) state");
    }
}
...
- (void)test82
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<a a =a"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in attribute value (unquoted) state");
    }
}
...
- (void)test83
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<a a ='a'"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"EOF in after attribute value state");
    }
}
