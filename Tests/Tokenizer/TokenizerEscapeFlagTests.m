...
@interface TokenizerEscapeFlagTests : XCTestCase
...
- (void)test0
{
    ...
    for (NSString *state in @[@"RCDATA state", @"RAWTEXT state"]) {
        ...
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Commented close tag in RCDATA or RAWTEXT");
    }
}
...
- (void)test1
{
    ...
    for (NSString *state in @[@"RCDATA state", @"RAWTEXT state"]) {
        ...
        tokenizer.state = StateNamed(state);
        [tokenizer setLastStartTag:@"xmp"];
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Bogus comment in RCDATA or RAWTEXT");
    }
}
...
- (void)test2
{
    ...
    for (NSString *state in @[@"RCDATA state", @"RAWTEXT state"]) {
        ...
        tokenizer.state = StateNamed(state);
        [tokenizer setLastStartTag:@"xmp"];
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"End tag surrounded by bogus comment in RCDATA or RAWTEXT");
    }
}
...
- (void)test3
{
    ...
    for (NSString *state in @[@"RCDATA state"]) {
        ...
        tokenizer.state = StateNamed(state);
        [tokenizer setLastStartTag:@"xmp"];
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Commented entities in RCDATA");
    }
}
...
- (void)test4
{
    ...
    for (NSString *state in @[@"RCDATA state", @"RAWTEXT state"]) {
        ...
        tokenizer.state = StateNamed(state);
        [tokenizer setLastStartTag:@"xmp"];
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Incorrect comment ending sequences in RCDATA or RAWTEXT");
    }
}
