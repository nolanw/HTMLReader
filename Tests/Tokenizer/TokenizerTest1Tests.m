...
@interface TokenizerTest1Tests : XCTestCase
...
- (void)test00
{
    ...
    for (NSString *state in @[@""]) {
        ...
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Correct Doctype lowercase");
    }
}
...
- (void)test01
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!DOCTYPE HTML>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Correct Doctype uppercase");
    }
}
...
- (void)test02
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!DOCTYPE HtMl>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Correct Doctype mixed case");
    }
}
...
- (void)test03
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!DOCTYPE HtMl"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Correct Doctype case with EOF");
    }
}
...
- (void)test04
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Truncated doctype start");
    }
}
...
- (void)test05
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Doctype in error");
    }
}
...
- (void)test06
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Single Start Tag");
    }
}
...
- (void)test07
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Empty end tag");
    }
}
...
- (void)test08
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Empty start tag");
    }
}
...
- (void)test09
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Start Tag w/attribute");
    }
}
...
- (void)test10
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<h a=b>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Start Tag w/attribute no quotes");
    }
}
...
- (void)test11
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Start/End Tag");
    }
}
...
- (void)test12
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Two unclosed start tags");
    }
}
...
- (void)test13
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"End Tag w/attribute");
    }
}
...
- (void)test14
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Multiple atts");
    }
}
...
- (void)test15
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<h a='b'c='d'>"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Multiple atts no space");
    }
}
...
- (void)test16
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Repeated attr");
    }
}
...
- (void)test17
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Simple comment");
    }
}
...
- (void)test18
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!----->"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Comment, Central dash no space");
    }
}
...
- (void)test19
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!-- --comment -->"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Comment, two central dashes");
    }
}
...
- (void)test20
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!--comment"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Unfinished comment");
    }
}
...
- (void)test21
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!-"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Start of a comment");
    }
}
...
- (void)test22
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!-->"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Short comment");
    }
}
...
- (void)test23
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!--->"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Short comment two");
    }
}
...
- (void)test24
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"<!---->"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Short comment three");
    }
}
...
- (void)test25
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"&"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Ampersand EOF");
    }
}
...
- (void)test26
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"&&"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Ampersand ampersand EOF");
    }
}
...
- (void)test27
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"& "];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Ampersand space EOF");
    }
}
...
- (void)test28
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Unfinished entity");
    }
}
...
- (void)test29
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"&#"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Ampersand, number sign");
    }
}
...
- (void)test30
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Unfinished numeric entity");
    }
}
...
- (void)test31
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Entity with trailing semicolon (1)");
    }
}
...
- (void)test32
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Entity with trailing semicolon (2)");
    }
}
...
- (void)test33
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Entity without trailing semicolon (1)");
    }
}
...
- (void)test34
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"I'm &notin"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Entity without trailing semicolon (2)");
    }
}
...
- (void)test35
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Partial entity match at end of file");
    }
}
...
- (void)test36
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"&¬;"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Non-ASCII character reference name");
    }
}
...
- (void)test37
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"&#0036;"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"ASCII decimal entity");
    }
}
...
- (void)test38
{
    ...
    for (NSString *state in @[@""]) {
        HTMLTokenizer *tokenizer = [[HTMLTokenizer alloc] initWithString:@"&#x3f;"];
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"ASCII hexadecimal entity");
    }
}
...
- (void)test39
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Hexadecimal entity in attribute");
    }
}
...
- (void)test40
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Entity in attribute without semicolon ending in x");
    }
}
...
- (void)test41
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Entity in attribute without semicolon ending in 1");
    }
}
...
- (void)test42
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Entity in attribute without semicolon ending in i");
    }
}
...
- (void)test43
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Entity in attribute without semicolon");
    }
}
...
- (void)test44
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Unquoted attribute ending in ampersand");
    }
}
...
- (void)test45
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Unquoted attribute at end of tag with final character of &, with tag followed by characters");
    }
}
...
- (void)test46
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"plaintext element");
    }
}
...
- (void)test47
{
    ...
    for (NSString *state in @[@""]) {
        ...
        tokenizer.state = StateNamed(state);
        XCTAssertEqualObjects(tokenizer.allObjects, expectedTokens, @"%@", @"Open angled bracket in unquoted attribute value state");
    }
}
