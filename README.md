...
HTMLReader is continually built and tested on the SDKs available via GitHub Actions. It is intended work on down to iOS 5.0, macOS 10.7, tvOS 9.0, and watchOS 2.0, but there is no automated testing (it's ok to file an issue though!).

Given all that: [![Build Status](https://github.com/nolanw/HTMLReader/actions/workflows/test.yml/badge.svg)](https://github.com/nolanw/HTMLReader/actions/workflows/test.yml)
